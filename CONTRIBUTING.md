...
Your contributions to the VIXAL network will help improve the world’s financial
infrastructure, faster.

We want to make it as easy as possible to contribute changes that
help the VIXAL network grow and thrive. There are a few guidelines that we
...
* Submit a pull request to the corresponding repository in the VIXAL organization.
...
* [Bug tracker (Github)](https://github.com/vixledger/ruby-vixal-base/issues)
